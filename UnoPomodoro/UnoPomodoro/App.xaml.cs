...
public partial class App : Application
{
    ...
    protected override void OnLaunched(LaunchActivatedEventArgs args)
    {
        ...
        // Ensure SQLite native provider is initialized (required on Android)
        SQLitePCL.Batteries_V2.Init();

        var dbPath = System.IO.Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "pomodoro.db");
        ...
        var sessionRepository = new SessionRepository(connection);
        var taskRepository = new TaskRepository(connection);
        var soundService = new SoundService();
        var notificationService = new NotificationService();

        // Create MainViewModel with required services
        var mainViewModel = new MainViewModel(timerService, sessionRepository, taskRepository, soundService, notificationService);
